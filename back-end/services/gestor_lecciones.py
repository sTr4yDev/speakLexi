...
class GestorLecciones:
    ...
    def crear_leccion(self, datos_leccion, usuario_id):
        ...
        try:
            ...
            curso = Curso.query.get(datos_leccion['curso_id'])
            if not curso:
                return {"error": f"El curso con ID {datos_leccion['curso_id']} no existe"}, 404
    ...
    def actualizar_leccion(self, leccion_id, datos_actualizados, usuario_id):
        ...
        try:
            ...
            if 'curso_id' in datos_actualizados:
                ...
                if not curso:
                    return {"error": "El curso especificado no existe"}, 404
    ...
    def obtener_lecciones_por_curso(self, curso_id, solo_publicadas=True):
        ...
        Args:
            ...
            solo_publicadas (bool): Si solo retornar lecciones publicadas
        ...
        try:
            ...
            query = Leccion.query.filter_by(curso_id=curso_id)
            
            if solo_publicadas:
                query = query.filter_by(estado=EstadoLeccion.PUBLICADA)
            ...
            return {"error": f"Error al obtener lecciones del curso: {str(e)}"}, 500
