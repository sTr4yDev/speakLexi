...
class GestorUsuarios:
    ...
    def autenticar_usuario(self, correo, password):
        """Autentica un usuario y verifica su estado"""
    ...
    def eliminar_cuenta_permanente(self, usuario_id):
        ...
        try:
            ...
            db.session.commit()
            print(f"✅ Cuenta eliminada permanentemente: {usuario.correo}")
    ...
    def solicitar_recuperacion_password(self, correo):
        ...
        if not usuario:
            ...
            return {"mensaje": "Si el correo existe, recibirás instrucciones para recuperar tu contraseña"}, 200
